        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label" for="Municipio">Municipio:<span class="text-danger">*</span></label>
                        <div class="col-lg-6">
                            <input class="form-control" id="Municipio" type='text' name='mun_prov' value="{{$proveedores->mun_prov}}">
                        </div>
                    </div>
